...
class BEVFormerHead(DETRHead):
    ...
    def get_targets(self,
        ...
        (labels_list, label_weights_list, bbox_targets_list,
         bbox_weights_list, pos_inds_list, neg_inds_list, sampling_result_list) = multi_apply(
            self._get_target_single, cls_scores_list, bbox_preds_list,
            gt_labels_list, gt_bboxes_list, gt_bboxes_ignore_list)
        num_total_pos = sum((inds.numel() for inds in pos_inds_list))
        num_total_neg = sum((inds.numel() for inds in neg_inds_list))
        return (labels_list, label_weights_list, bbox_targets_list,
                bbox_weights_list, num_total_pos, num_total_neg, sampling_result_list)
    ...
    def loss_single(self,
        ...
        (labels_list, label_weights_list, bbox_targets_list, bbox_weights_list,
         num_total_pos, num_total_neg, sampling_result_list) = cls_reg_targets
        ...
        return loss_cls, loss_bbox, sampling_result_list
    ...
    def loss(self,
        ...
        losses_cls, losses_bbox, sampling_results = multi_apply(
        ...
        for loss_cls_i, loss_bbox_i in zip(losses_cls[:-1],
            ...
            num_dec_layer += 1
        return loss_dict, sampling_results
    ...
    #     all_gt_bboxes_list = [gt_bboxes_list for _ in range(num_dec_layers)]
    #     all_gt_labels_list = [gt_labels_list for _ in range(num_dec_layers)]
    #     all_gt_captions_list = [gt_captions_list for _ in range(num_dec_layers)]
    #     all_gt_caplabels_list = [gt_caplabels_list for _ in range(num_dec_layers)]
    ...
    #         self.caploss_single, all_cls_scores, all_bbox_preds,
    #         all_gt_bboxes_list, all_gt_labels_list,
    #         all_gt_captions_list, all_gt_caplabels_list,
    #         all_gt_bboxes_ignore_list)


    # def caploss_single(self,
    #                 cls_scores,
    #                 bbox_preds,
    #                 gt_bboxes_list,
    #                 gt_labels_list,
    ...
    #     cls_reg_targets = self.get_cap_targets(cls_scores_list, bbox_preds_list,
    #                                             gt_bboxes_list, gt_labels_list,
    #                                             gt_captions_list, gt_caplabels_list,
    #                                             gt_bboxes_ignore_list)
    ...
    #     (labels_list, label_weights_list, bbox_targets_list, 
    #      caption_targets_list, caption_weights, caplabel_targets_list,
    #      bbox_weights_list, pos_inds_list, neg_inds_list) = multi_apply(
    #         self._get_cap_target_single, cls_scores_list, bbox_preds_list,
    #         gt_bboxes_list, gt_labels_list, 
    #         gt_captions_list, gt_caplabels_list, 
    #         gt_bboxes_ignore_list)
    #     num_total_pos = sum((inds.numel() for inds in pos_inds_list))
    ...
    # def _get_cap_target_single(self,
    #                        cls_score,
    #                        bbox_pred,
    #                        gt_bboxes,
    #                        gt_labels,
    ...
    #     # caption targets
    #     # TODO:2023年8月4日 18:33:37
    #     caption_targets = torch.zeros_like(gt_captions)[..., :gt_c]
    #     caption_weights = torch.zeros_like(gt_captions)
    #     caption_weights[pos_inds] = 1.0


    #     # caplabel targets, share the same weights with caption
    #     caplabel_targets = torch.zeros_like(gt_caplabels)[..., :gt_c]
    ...
    #     bbox_targets[pos_inds] = sampling_result.pos_gt_bboxes
    #     return (labels, label_weights, bbox_targets, bbox_weights, 
    #             caption_targets, caplabel_targets, caption_weights,
    #             pos_inds, neg_inds)
