...
class ObjectRangeFilter:
    ...
    def __call__(self, data):
        ...
        if 'gt_captions_3d' in data:
            gt_captions_3d = np.array(data['gt_captions_3d'])[mask.numpy().astype(np.bool)]
            data['gt_captions_3d'] = gt_captions_3d
...
class ObjectNameFilter:
    ...
    def __call__(self, data):
        ...
        if 'gt_captions_3d' in data:
            data['gt_captions_3d'] = data['gt_captions_3d'][gt_bboxes_mask]
