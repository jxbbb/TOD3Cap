...
class DetectionEval:
    ...
    def __init__(self,
        ...
        with open("/DATA_EDS2/zyp/jinbu/jinbu_18/nuscenes-caption/Final_caption/final_caption_v2/final_caption_bbox_token.json", "r") as f:
    ...
    def main(self,
        ...
        for sample_token in sample_tokens:
            ...
            for pred_object_box in pred_box_one_sample:
                ...
                bbox_token = gt_box_one_sample[all_ious.index(max_iou)].caption
                ...
                record = {
                    ...
                    'iou': max_iou,
                    'candidate': pred_object_box.caption[0],
...
if __name__ == "__main__":
    ...
    parser.add_argument('--result_path', type=str, default='/home/aidrive/zyp/Surround_scene/bevfusion/runs/lidar/results_nusc.json', help='The submission as a JSON file.')
