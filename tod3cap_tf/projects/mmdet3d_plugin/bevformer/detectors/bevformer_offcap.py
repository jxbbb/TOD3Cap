...
class BEVFormer(MVXTwoStageDetector):
    ...
    def __init__(self,
        ...
        llama_ckpt_dir = "/data/jinbu/nuscenes-caption/Attribute/LLaMA-Adapter//LLaMA-7B/7B"
        llama_tokenzier_path = "/data/jinbu/nuscenes-caption/Attribute/LLaMA-Adapter//LLaMA-7B/tokenizer.model"
        self.llama_adapter = LLaMA_adapter(llama_ckpt_dir, llama_tokenzier_path, phase="pretrain")
    ...
    def forward_pts_train(self,
        ...
        with torch.no_grad():
            ...
            _, sampling_results = self.pts_bbox_head.loss(*loss_inputs, img_metas=img_metas)
        ...
        # get caption loss
        # caploss = self.caption_head_with_gt(outs, pts_feats, sampling_results, gt_bboxes_3d, gt_captions_3d, gt_caplabels_3d)
    ...
    def caption_head_with_gt(self, outs, pts_feats, sampling_results, gt_bboxes_3d, gt_captions_3d, gt_caplabels_3d):
        ...
        for bs in range(batch_size):
            ...
            sampled_indices = _downsamplecap(num_bboxes, 2)
            ...
            with torch.cuda.amp.autocast():
                caption_loss = self.llama_adapter((caption_targets, caplabel_targets, caption_weights), (bev_embed, gt_bbox.to(bev_embed.device)))
