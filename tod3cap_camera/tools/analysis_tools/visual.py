...
def render_sample_data(
    ...
    if out_path is not None:
        plt.savefig(out_path+'_camera_'+choose_object, bbox_inches='tight', pad_inches=0, dpi=200)
    if verbose:
        plt.show()
    plt.close()
...
if __name__ == '__main__':
    ...
    # bevformer_results = mmcv.load('test/bevformer_tiny/bbox_eval/pts_bbox/results_nusc.json')
    with open('test/bevformer_tiny/bbox_eval/pts_bbox/results_nusc.json') as f:
        bevformer_results = json.load(f)
    # sample_token_list = list(bevformer_results['results'].keys())
    # for id in range(0, 34149):
    #     render_sample_data(sample_token_list[id], pred_data=bevformer_results, out_path=sample_token_list[id])
    # sample = nusc.get("sample", "f38ef51177c84c2a9fa32584b79e601e")
    # for sensor in [""]
    # sensor_token = sample['data'][sensor]
    # for sample_token in ["27db2832d44144829b896d46b441f66c", "daeec5222fb346f99addae0db196eb1e", "5a54a45e59ad48cab7213ff7d1828f3c", "b16c13a33031451e97116a3149783fa9", "1cc4743fc70047ad8eac0777e43cfe57",
                        #  "72f030bd5dd142d497c090dc04bb5697", "e8dd2a90a84142b2aa1c42126d3f135b", "b66b4277cf6145bbabb891ea7193dfa6", "3f649706222f4d83aa0a8a1b687f29fa", "b3537c4657784727934760188904dde8"]:
    for sample_token in ["5a54a45e59ad48cab7213ff7d1828f3c"]:
        render_sample_data(sample_token, pred_data=bevformer_results, out_path=sample_token)
