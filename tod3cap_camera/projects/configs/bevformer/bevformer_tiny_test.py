...
model = dict(
    ...
    pts_bbox_head=dict(
        ...
        bbox_coder=dict(
            ...
            pc_range=point_cloud_range,
            # FIXME: change to 64 when evaluate caption
            max_num=64,
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file=data_root + 'bevcap-bevformer-trainval_infos_temporal_train.pkl',
    ...
    val=dict(type=dataset_type,
             data_root=data_root,
             ann_file=data_root + 'bevcap-bevformer-trainval_infos_temporal_val.pkl',
