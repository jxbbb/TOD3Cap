...
class ObjectRangeFilter(object):
    ...
    def __call__(self, input_dict):
        ...
        if 'gt_captions_3d' in input_dict:
            gt_captions_3d = np.array(input_dict['gt_captions_3d'])[mask.numpy().astype(np.bool)]
            input_dict['gt_captions_3d'] = gt_captions_3d
...
class ObjectNameFilter(object):
    ...
    def __call__(self, input_dict):
        ...
        if 'gt_captions_3d' in input_dict:
            input_dict['gt_captions_3d'] = input_dict['gt_captions_3d'][gt_bboxes_mask]
